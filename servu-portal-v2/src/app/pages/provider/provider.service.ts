...
export class ProviderService {
    ...
    public _scList = [];
    public __scListSubject = new Subject<Object>();


//GET /portal/staff/calendar
    getStaffCalender(id){
        return this._pr.getStaffCalendar(id);
    }

    updateCalenderStatus(g: any) {
        return this._pr.updateStaffCalendar(g);
    }
    deletStaffCalender(id,gId){
        return this._pr.deletStaffCalender(id,gId);
    }
}
