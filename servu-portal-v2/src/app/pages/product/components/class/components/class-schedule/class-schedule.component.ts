...
import {AuthRest} from "app/restServices/authRest.service";
...
export class ClassScheduleComponent implements OnInit {
    ...
    constructor(public _ps: ProductService, public proS: ProviderService,public authUser:AuthRest) {
        proS.getList(authUser.getBranchId()).subscribe(r=>{
            this.staffList = r;
        });
    }
