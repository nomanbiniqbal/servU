...
export class BaCardBlur {
  ...
  public _bodyBgSize:BgMetrics;

  constructor(public _baConfig:BaThemeConfigProvider, public _baCardBlurHelper:BaCardBlurHelper, public _el:ElementRef) {
    if (this._isEnabled()) {
  ...
  public _getBodyImageSizesOnBgLoad():void {
  ...
  public _recalculateCardStyle():void {
    if (!this._bodyBgSize) {
      return;
    }
